        ...
        <div class="pt-1 ">
            ...
            <form class="form_input display-block" action="/product" method="post">
                ...
                <div class="form-group form_input row ">
                    ...
                    <div class="col">
                        <input type="text" name="name" value="${product.name}" class="form-control" id="inputName"
                ...
                <div class="form-group form_input row ">
                    ...
                    <div class="col">
                        <input type="text" name="price" value="${product.gia}" class="form-control" id="inputPrice"
                ...
                <div class="form-group form_input row ">
                    ...
                    <div class="col">
                        <input type="text" name="soluong" value="${product.soLuong}" class="form-control"
                               id="inputSoLuong" placeholder="Nhập số lượng">
                    </div>
                </div>
                <div class="form-group form_input row ">
                ...
                <div class="form-group form_input row ">
                    ...
                    <div class="col">
                        <input name="des" value="${product.moTa}" class="form-control" id="des"
                ...
                <div class="form-group form_input row ">
                    ...
                    <div class="col">
                        <select name="category" value="${product.id_category}" class="form-control" id="category">
